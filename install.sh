...
then
  ...
  echo "| Script testé sur Debian 9.5. Le lancer sur une machine propre est fortement recommandé.                                                 |"
  ...
  echo "| Flood |"
  echo "---------"
  echo "On peut vérifier que Flood est bien lancé avec un ps -aux | grep flood"
  echo "Pour arrêter Flood : systemctl stop flood"
  echo "Pour lancer Flood : systemctl start flood"
